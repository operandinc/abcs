...
type Config struct {
	...
	ClearMsgs bool `xml:"clear_messages" json:"clear_messages,omitempty" toml:"clear_messages,_omitempty" yaml:"clear_messages"`
	// This is the channel buffer size.
	QueueSize int `xml:"queue_size" json:"queue_size,omitempty" toml:"queue_size,_omitempty" yaml:"queue_size"`
	// How many applescript retries to perform.
	Retries int `xml:"retries" json:"retries,omitempty" toml:"retries,_omitempty" yaml:"retries"`
